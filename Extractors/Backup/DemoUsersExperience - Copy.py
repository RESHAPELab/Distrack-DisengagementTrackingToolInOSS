...
def collect_repo(repo, since_days):
    ...
    # give a raw appended DataFrame

    return None

def clean_data(df):
    # We need to return a very specific combined, daily, segmentized, prepopulated raw data
    # Return the cleaned DataFrame ready for analysis or modeling
    return df  # Placeholder: implement actual cleaning logic
...
if st.button("Collect Data Demo"):
        raw = collect_repo(repo_key, since_days=90)
